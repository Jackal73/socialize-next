            ...
            <div className="flex flex-wrap justify-between gap-2 xl:gap-4">
              ...
              <div className="flex flex-col gap-2 mt-2">
                ...
                <input
                  type="text"
                  className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm"
                  placeholder={user.description || "live an honest life"}
                  name="description"
                />
              </div>
              {/* INPUT */}
              ...
              <div className="flex flex-col gap-2 mt-2">
                ...
                <input
                  type="text"
                  className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm"
                  placeholder={user.city || "Des Moines"}
                  name="city"
                />
              </div>
              {/* INPUT */}
              ...
              <div className="flex flex-col gap-2 mt-2">
                ...
                <input
                  type="text"
                  className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm"
                  placeholder={user.school || "Missouri S&T"}
                  name="school"
                />
              </div>
              {/* INPUT */}
              ...
              <div className="flex flex-col gap-2 mt-2">
                ...
                <input
                  type="text"
                  className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm"
                  placeholder={user.website || "lynkx.vercel.app/Jackal73"}
                  name="website"
                />
              </div>
            </div>
